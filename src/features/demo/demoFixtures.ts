...
const diseases = [
  ...
  dis('ds3', 'Фибрилляция предсердий', 'кардиология', ['I48'], 'Нерегулярный ритм; решается вопрос об антикоагулянтной терапии.', ['ФП', 'мерцалка']),
  ...
  dis('ds8', 'Гипотиреоз', 'эндокринология', ['E03'], 'Дефицит тиреоидных гормонов: слабость, отёки, брадикардия.', []),
