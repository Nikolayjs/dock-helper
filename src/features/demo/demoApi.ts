...
const BACKEND_ONLY = [
  ...
  '/extension-tokens',
  // Справочник микробиологии живёт на сервере, как и МКБ-10. Урезанная копия в демо была бы хуже
  // отсутствия: без части правил природной устойчивости разбор объявил бы бланк чистым там, где он
  // не чист, — то есть показал бы не продукт, а его подделку.
  '/microbiology/',
];
