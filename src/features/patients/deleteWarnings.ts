...
/**
 * Сохранённые анализы уходят вместе с пациентом, и сказать об этом обязательно.
 *
 * У карт диспансерного учёта иначе: у них есть свой раздел, и карта удалённого пациента честно
 * стоит в отчёте строкой «Пациент удалён». У набора чисел такого раздела нет — единственный вход в
 * них через карточку, — поэтому они удаляются, а не остаются невидимыми.
 */
