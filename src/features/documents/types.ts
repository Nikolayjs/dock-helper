 ...
 *
 * Заголовки пустые. Придуманное за врача «Столбец 1» пришлось бы стирать перед тем, как написать
 * своё, а столбец и без него назван — буквой в шапке, той же, которой он зовётся в формулах.
 */
